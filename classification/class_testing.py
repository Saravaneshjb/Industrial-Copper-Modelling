...
class ClassificationTestingPipeline:
    def __init__(self, pickle_folder_path):
        ...
        self.feature_order = ['quantity tons', 'customer', 'country', 'item type', 'application',
    ...
    def preprocess(self, input_data):
        ...
        df[['thickness', 'width', 'quantity tons','selling_price']] = self.scaler.transform(df[['thickness', 'width', 'quantity tons','selling_price']])
